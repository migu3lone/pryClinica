...
public final class ItemMedicoBinding implements ViewBinding {
  ...
  private ItemMedicoBinding(@NonNull LinearLayout rootView, @NonNull ImageView editar,
      @NonNull ImageView eliminar, @NonNull TextView vr1, @NonNull TextView vr2,
      @NonNull TextView vr3, @NonNull TextView vr4, @NonNull TextView vr5, @NonNull TextView vr6) {
  ...
  public static ItemMedicoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMedicoBinding((LinearLayout) rootView, editar, eliminar, vr1, vr2, vr3, vr4,
          vr5, vr6);
    }
