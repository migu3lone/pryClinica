...
public final class ItemEspmedBinding implements ViewBinding {
  @NonNull
  ...
  private ItemEspmedBinding(@NonNull LinearLayout rootView, @NonNull ImageView editar,
      @NonNull ImageView eliminar, @NonNull TextView vr1, @NonNull TextView vr2,
      @NonNull TextView vr3) {
  ...
  @NonNull
  public static ItemEspmedBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemEspmedBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_espmed, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemEspmedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEspmedBinding((LinearLayout) rootView, editar, eliminar, vr1, vr2, vr3);
    }
