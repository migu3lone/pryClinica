...
function handlePostRequest() {
    ...
    global $dao, $var1, $var2, $var3, $var4, $var5, $var6, $var7, $var8, $var9;
	...
	if (isset($input[$var1]) && isset($input[$var2]) && isset($input[$var3]) && isset($input[$var4]) && isset($input[$var5]) && isset($input[$var6]) && isset($input[$var7]) && isset($input[$var8]) && isset($input[$var9])) {
        $var1x = $input[$var1];
        $var2x = $input[$var2];
        $var3x = $input[$var3];
        $var4x = $input[$var4];
		...
		if (!empty($dao::getById($var1x))) {
            $result = $dao::update($var1x, $var2x, $var3x, $var4x, $var5x, $var6x, $var7x, $var8x, $var9x);
		...
		// llamando al método insert() del DAO
            ...
            $result = $dao::insert($var2x, $var3x, $var4x, $var5x, $var6x, $var7x, $var8x, $var9x);
    ...
    // Si alguna de las variables necesarias ($var1 a $var9) no está presente en el cuerpo de la solicitud,
