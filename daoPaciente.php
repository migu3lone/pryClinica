...
ORDER BY IdPaciente ASC";
    ...
    public static function update($var1, $var2, $var3, $var4, $var5, $var6, $var7, $var8, $var9) {
        //call actPaciente("C001", "P005", "E001", "M002", "2028-08-05", "08:11:33.000000");
        $sql = "call actPaciente(?, ?, ?, ?, ?, ?, ?, ?, ?)";

        try {
            $stmt = Database::getInstance()->getDb()->prepare($sql);
            $state = $stmt->execute([$var1, $var2, $var3, $var4, $var5, $var6, $var7, $var8, $var9]);
            return $state;
        } catch (PDOException $e) {
    ...
    public static function insert($var2, $var3, $var4, $var5, $var6, $var7, $var8, $var9) {
        //call agrCita("P001", "E001", "M001", "2025-08-05", "08:11:33.000000");
        $sql = "call agrPaciente(?, ?, ?, ?, ?, ?, ?, ?)";

        try {
            $stmt = Database::getInstance()->getDb()->prepare($sql);
            $state = $stmt->execute([$var2, $var3, $var4, $var5, $var6, $var7, $var8, $var9]);
            return $state;
        } catch (PDOException $e) {
